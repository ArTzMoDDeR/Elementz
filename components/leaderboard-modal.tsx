...
export function LeaderboardModal({ lang, onClose }: LeaderboardModalProps) {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 z-[999] flex flex-col md:w-[440px] md:max-h-[80vh] bg-card md:rounded-2xl border border-border shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-250 overflow-hidden [padding-top:calc(env(safe-area-inset-top,0px)+16px)] [padding-bottom:calc(env(safe-area-inset-bottom,0px)+12px)] md:[padding-top:0px] md:[padding-bottom:0px]">
