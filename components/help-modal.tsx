      ...
      <div className="flex flex-col gap-5 items-center">
        ...
        <div className="flex flex-col gap-2 w-full">
          <form action={signInWithGoogle}>
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2.5 h-11 px-5 rounded-xl bg-foreground text-background text-sm font-semibold hover:opacity-90 transition-opacity"
            >
          ...
          <form action={signInWithDiscord}>
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2.5 h-11 px-5 rounded-xl bg-[#5865F2] text-white text-sm font-semibold hover:opacity-90 transition-opacity"
            >
