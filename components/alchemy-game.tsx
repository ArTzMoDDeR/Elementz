      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col gap-3 w-full">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 h-13 px-5 rounded-2xl bg-foreground text-background text-sm font-semibold hover:opacity-90 active:scale-[0.98] transition-all disabled:opacity-60"
            style={{ height: 52 }}
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-muted-foreground/60">{t('ou', 'or')}</span>
            <div className="flex-1 h-px bg-border" />
          </div>
