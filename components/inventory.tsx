          ...
          <div className="px-3 py-2 border-b border-border">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-7 pr-7 py-1.5 bg-muted/50 rounded-md text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring"
              />
              {search && (
                <button
                  onClick={() => setSearch('')}
